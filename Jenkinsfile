        ...
        stage('Build Docker images on Build Server') {
            steps {
                script {
                    ...
                    sh "ssh ubuntu@172.31.81.175 'ansible-playbook /home/ubuntu/build.yaml'"                    // 'ansible-playbook /home/ubuntu/playbook.yaml'"
        ...
        stage('Deploy Script on Deploy Server') {
            steps {
                script {
                    ...
                    sh "ssh ubuntu@172.31.81.175 'ansible-playbook /home/ubuntu/deploy.yaml'"
                }
            }
        }
    }
